...
public class Xls_Reader {
 ...
 // find whether sheets exists	
	 ...
	 * 
	 * @param sheetName The name of the Sheet from the Controller.xlsx	
	...
	public static Object[][] getData(String sheetName){
	    ...
	    rows = BaseClass.datatable.getRowCount(sheetName);  // 3
	...
	public static boolean isSkip(String testCase){
		try {
			...
			BaseClass.writeLog("General exception occured in function isSkip in Xls_Reader class");
			//e.printstacktrace();
			return false;
		}
